...
public class OrderService {
    ...
    // 주문 생성 (트랜잭션 처리)
    public boolean createOrder(String userId, int orderTotal, int orderStatus, 
...
class OrderInfo {
    ...
    public void setOrderDetails(List<OrderDetailInfo> orderDetails) { this.orderDetails = orderDetails; }
}
