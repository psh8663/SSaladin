...
//		boolean flag = false;
//
//		String sql = "INSERT INTO point_requests " + "(request_num, user_id, point_amount, request_status, request_date) "
//				+ "VALUES (point_requests_seq.NEXTVAL, ?, ?, 1, ?)";
//
//		try {
//
...
//	                + "point_used, request_date FROM point_requests "
...
//	                + "FROM point_requests r JOIN users u ON r.user_id = u.user_id "
//	                + "WHERE r.request_num = ?";
//	        
//	        try {
//	            conn = DBUtil.getConnection();
